        ...
        <div class="col-lg-12">
          <div class="row">
           ...
           <?php 
                     ...
                     $selectQuery = "SELECT COUNT(user_id) as `total` FROM `student_details` where course in ('MCA','Mca')";
                     $selectQuery1 = "SELECT COUNT(user_id) as `total` FROM `student_details` where course in ('BTECH','Btech')";
                     $selectQuery2 = "SELECT COUNT(user_id) as `total` FROM `student_details` where course in ('BPHARMA','Bphrama')";
                     $selectQuery3 = "SELECT COUNT(user_id) as `total` FROM `student_details` where course in ('MBA','Mba')";
                     $result = mysqli_query($connectQuery,$selectQuery);
