    ...
    <tr>
      ...
      if( $nor==0 ){
        ...
        while($row = mysqli_fetch_assoc($result)){
          echo "<tr><td>{$n}</td><td>{$row['company_name']}</td><td>{$row['eligible_branches']}</td><td>{$row['job_profile']}</td><td>{$row['ctc']} LPA</td><td><input type= 'button' value='view' class='btn btn-primary' onclick='save()'></td></tr>\n";
            $n++;
        }
      }
    ?>
